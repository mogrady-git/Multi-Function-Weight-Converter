...
function updateValues() {
    ...
    switch (inputType.value) {
        case "kilograms":
            updateOutput(Converter.kilogramsToAll(input));
            break;
        case "grams":
            updateOutput(Converter.gramsToAll(input));
            break;
        case "pounds":
            updateOutput(Converter.poundsToAll(input));
            break;
        case "ounces":
            updateOutput(Converter.ouncesToAll(input));
            break;
